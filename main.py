...
from game.constants import PLAYER_ACTIONS, STATUS_TEMPLATE, TAMAGOCHI_IS_SICK
...
def main() -> None:
    """Создаёт игровые объекты и запускает консольную игру."""
    all_food = [
    ...
    while True:
        ...
        except NotEnoughError as error:
            print(error)
